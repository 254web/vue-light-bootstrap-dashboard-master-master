  ...
  <card class="card-user">
    ...
    <div class="author">
      <a href="#">
        ...
        <h4 class="title">Omar Suleiman<br />
          <small>Co-founder - System Analyst</small>
        </h4>
      </a>
    </div>
    <p class="description text-center"> "One Way Of Sucess <br>
      Is to Work Together <br>
      TuCode Tech - Solutons You Can Trust"
    </p>
